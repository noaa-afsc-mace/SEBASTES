...
class QViewerBase(QGraphicsView):
    ...
    def mouseReleaseEvent(self, ev):
        ...
        #  panning...
        if QGuiApplication.queryKeyboardModifiers()==Qt.AltModifier and (ev.button() == Qt.LeftButton):
            #  we're done panning
            self.leftBtnClicked = False
...
#                            pass
    ...
    def mouseMoveEvent(self, ev):
        ...
        if self.rubberBanding:
            ...
            self.rubberBandObj.setGeometry(self.rubberBandRect)
            self.emitMouseMoveEvent(self.mapToScene(ev.pos()), self.currentKbKey, [], [])
        ...
        elif QGuiApplication.queryKeyboardModifiers()==Qt.AltModifier:
    ...
    def keyPressEvent(self, ev):
        ...
        if not (QGuiApplication.queryKeyboardModifiers()==Qt.CtrlModifier):
    ...
    def wheelEvent(self, ev):
        ...
        if QGuiApplication.queryKeyboardModifiers()==Qt.CtrlModifier:
            #  we're zooming
    ...
    def scrollContentsBy(self, x, y):
        ...
        if not (QGuiApplication.queryKeyboardModifiers()==Qt.AltModifier or QGuiApplication.queryKeyboardModifiers()==Qt.CtrlModifier or self.isSettingCtrPt):
