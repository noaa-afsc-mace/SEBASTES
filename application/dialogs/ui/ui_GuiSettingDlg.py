...
class Ui_guiSettingDlg(object):
    def setupUi(self, guiSettingDlg):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.groupBox)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.groupBox_2)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.classLabelCheckBox)
        self.label_24 = QtWidgets.QLabel(guiSettingDlg)
        self.label_24.setObjectName("label_24")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_24)
        ...
        self.formLayout.setLayout(10, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_15)
        ...
        self.formLayout.setLayout(11, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_14)
        ...
        self.label_5 = QtWidgets.QLabel(guiSettingDlg)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.showSpcNameCheck = QtWidgets.QCheckBox(guiSettingDlg)
        self.showSpcNameCheck.setObjectName("showSpcNameCheck")
        self.horizontalLayout_5.addWidget(self.showSpcNameCheck)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5.addItem(spacerItem3)
        self.label_6 = QtWidgets.QLabel(guiSettingDlg)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_5.addWidget(self.label_6)
        self.spcNameLengthEdit = QtWidgets.QLineEdit(guiSettingDlg)
        self.spcNameLengthEdit.setObjectName("spcNameLengthEdit")
        self.horizontalLayout_5.addWidget(self.spcNameLengthEdit)
    ...
    def retranslateUi(self, guiSettingDlg):
        ...
        self.label_5.setText(_translate("guiSettingDlg", "LabelSpeciesName"))
        self.showSpcNameCheck.setText(_translate("guiSettingDlg", "Show Species"))
        self.label_6.setText(_translate("guiSettingDlg", "Number of characters to show "))
